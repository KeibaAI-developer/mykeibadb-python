...
| ODDS_SAITEI |   | 最低オッズ | 4.0 | 999.9倍で設定　ただし2004年8月13日以前は99.9倍が設定できる最高値とする | 0038 |
|   |   |   |   | “0999”:99.9倍以上　”0000″:無投票　”—-“:発売前取消　”\*\*\*\*”:発売後取消　” “:登録なし(sp) |  |
| ODDS_SAIKOU |   | 最高オッズ | 4.0 | 999.9倍で設定　ただし2004年8月13日以前は99.9倍が設定できる最高値とする | 0060 |
|   |   |   |   | “0999”:99.9倍以上　”0000″:無投票　”—-“:発売前取消　”\*\*\*\*”:発売後取消　” “:登録なし(sp) |  |
| NINKI |   | 人気順 | 2.0 | スペース:登録なし ‘–‘:発売前取消 ‘\*\*’:発売後取消 無投票の時は発売されている組合せの最大値を設定 | 06 |

## 追加カラム一覧

`OddsGetter.get_odds1_fukusho()` メソッドではデフォルトで`convert_codes=True`が指定されており、以下のカラムが追加されます。
