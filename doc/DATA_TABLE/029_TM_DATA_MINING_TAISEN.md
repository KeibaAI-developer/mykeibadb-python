...
| RECORD_SHUBETSU_ID |   | レコード種別ID | 2.0 | TMをセットレコードフォーマットを特定する |
...
| DATA_SAKUSEI_JIFUN |   | データ作成時分 | 2.0 | 時分各2桁 |
|   |   | <マイニング予想> | 6.0 |   |
| UMABAN1 |   | 馬番 | 2.0 | 該当馬番01～18 |
| MINING_YOSO1_SCORE |   | 予測スコア | 4.0 | 000.0～100.0で設定右から1バイト目を小数点第一位とする |
| : |   |   |   |   |
